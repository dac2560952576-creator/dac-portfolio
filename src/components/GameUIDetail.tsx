  ...
  return (
    <div className="relative min-h-screen px-5 pt-6 pb-20 sm:px-8 sm:pt-8 sm:pb-24 md:px-10 md:pt-10 md:pb-32">
      ...
      >
        ...
        >
          UI Design · Game Interface · Immersive Gaming
        </p>
      </motion.div>
      ...
      <div className="mx-auto max-w-7xl space-y-32 sm:space-y-40 md:space-y-52">
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-4 md:w-[22%]">
            ...
            <p className="font-light leading-relaxed text-[#D7E2EA]/60" style={{ fontSize: 'clamp(0.9rem, 1.3vw, 1.15rem)' }}>
              A responsive brand website inspired by Game's design language — bold typography, cinematic full-bleed imagery, and a premium dark-themed interface that honors the marque's heritage while pushing digital boundaries.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-4 md:w-[17%]">
            ...
            <p className="font-light leading-relaxed text-[#D7E2EA]/60" style={{ fontSize: 'clamp(0.9rem, 1.3vw, 1.15rem)' }}>
              Interactive inventory management with drag-and-drop functionality, item comparison views, and real-time stat visualization that enhances player immersion.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-4 md:w-[30%] md:pl-8">
            ...
            <p className="font-light leading-relaxed text-[#D7E2EA]/60" style={{ fontSize: 'clamp(0.9rem, 1.3vw, 1.15rem)' }}>
              Cross-platform UI optimized for PC, console, and mobile — adaptive control schemes, resolution-independent assets, and smooth 60fps transitions throughout.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-4 md:w-[22%]">
            ...
            <p className="font-light leading-relaxed text-[#D7E2EA]/60" style={{ fontSize: 'clamp(0.9rem, 1.3vw, 1.15rem)' }}>
              A complete game UI kit with reusable components — buttons, sliders, health bars, mini-maps, and notification toasts — built on a consistent neon-dark design language.
            </p>
          </div>
        </motion.div>
      </div>
